...
class Updater {
    ...
    public function __construct() {
        ...
        $this->version       = KH_BCG_VERSION;
        $this->cache_key     = 'kh_barcode_updater';
    ...
    public function request(){
        ...
        if( false === $remote || ! $this->cache_allowed ) {
            ...
            $remote = wp_remote_get( 'https://repository.khat.es/kh-barcode.json?ver='.$this->version, [
                    'timeout' => 10,
                    'headers' => [
